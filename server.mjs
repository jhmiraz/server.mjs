...
const cleanUpScript = (script) => {
    const unwantedPhrases = [
        ...
        'in-depth analysis',  // Add other phrases that don’t fit your use case
    ];
...
// Modify your existing endpoint to use this function
app.post('/generate-script', async (req, res) => {
    ...
    try {
        ...
        generatedScript = cleanUpScript(generatedScript); // Clean up the script
